...
public class OperationsWithPrimitives {
    public static void main(String[] args) {
        ...
        double correctDivisionResult = (double)firstByteNumber / (double)secondByteNumber;
        ...
        System.out.println(firstByteNumber + " / " + secondByteNumber + " = " + correctDivisionResult + " (Correct result of division)");
        System.out.println("-------------------------------------------");

        short firstShortNumber = 30000;
        short secondShortNumber = 503;
        correctDivisionResult = (double)firstShortNumber / (double)secondShortNumber;
        ...
        System.out.println(firstShortNumber + " / " + secondShortNumber + " = " + correctDivisionResult + " (Correct result of division)");
        System.out.println("-------------------------------------------");

        long firstLongNumber = 54032100L;
        long secondLongNumber = 9258L;
        correctDivisionResult = (double)firstLongNumber / (double)secondLongNumber;
        ...
        System.out.println(firstLongNumber + " / " + secondLongNumber + " = " + correctDivisionResult + " (Correct result of division)");
        System.out.println("-------------------------------------------");
